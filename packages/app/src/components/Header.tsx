...
export function Header() {
  return (
    <header className='navbar sticky top-[0vh] z-10 border-solid border-bottom border-indigo-400 flex justify-between p-8 pt-0 pb-0 bg-primary text-neutral-content shadow-lg'>
